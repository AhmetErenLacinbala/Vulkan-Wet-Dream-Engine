...
/usr/local/bin/glslc shaders/point_light.vert -o shaders/point_light.vert.spv
/usr/local/bin/glslc shaders/point_light.frag -o shaders/point_light.frag.spv