...
public:
    ...
    public:
        ...
        // addBinding function appends to the map of bindings that information that vulcan requires saying what type of descriptor type to expect such as a uniform buffer, storage guffer, image buffer etc.
        // shader stages flags tell how vulcan which shader stages will access to this binding
        // count parameter descriptes how many descriptors is going to getting used
        Builder &addBinding(
            uint32_t binding,
